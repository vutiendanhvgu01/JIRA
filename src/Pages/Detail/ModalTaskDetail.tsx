...
const ModalTaskDetail = (props: Props) => {
  const { ModalOpen, userLogin } = useSelector((state: RootState) => {
    return state.UserReducer;
  });
  const { TaskDetail, TaskIdDetail, AllComment } = useSelector(
    (state: RootState) => {
      return state.TaskReducer;
    }
  );
  const { statusTask, taskType, Priority, detailProjectById } = useSelector(
    (state: RootState) => {
  ...
  const arrayAssign = detailProjectById?.members
    .filter((mem) => {
        ...
        <div className="modal-header">
          <div className="task-title">
            ...
            <span style={{ fontWeight: "bold" }}>
              {" "}
              {TaskDetail?.taskTypeDetail?.taskType} - {TaskDetail?.taskId}
            </span>
          </div>
                ...
                <div className="comment">
                  ...
                  <p className="my-2">
                    ...
                    <span>
                      {" "}
                      press{" "}
                      <span style={{ fontWeight: "bold", color: "#b4ac6" }}>
                        ENTER{" "}
                      </span>
                      to comment
                    </span>
              ...
              <div className="col-4">
                ...
                <div className="original-estinal mb-3">
                  ...
                  <Input
                    ...
                    defaultValue={Number(TaskDetail?.originalEstimate)}
                  />
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-6">
                    <Input
                      ...
                      value={trackingTime.timeTrackingRemaining}
