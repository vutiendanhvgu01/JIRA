      ...
      <div className="projectDetail-container">
        ...
        <div className="projectDetail-body row mt-4">
          {detailProjectById?.lstTask?.map((item: LstTask, index: number) => {
            return (
              <div
                className="card-wrap  mt-4 col-lg-3 col-md-3 col-xs-12 col-sm-12"
                key={index}
              >
                    ...
                    {item?.lstTaskDeTail.map(
                      (lstTask: LstTaskDeTail, index: number) => {
                        return (
                          <li
                            onClick={() => {
                              const actionTaskId = getTaskDetailIdAction(
                                lstTask.taskId
                              );
                              dispatch(actionTaskId);
                              const actionTaskDetail = getTaskDetailByApi(
                                lstTask.taskId
                              );
